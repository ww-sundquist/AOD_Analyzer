...
xMin = 0.49#restrict domain of fit, values taken by eye
xMax = 0.51
bottom = 0.0
top = 4300.0
...
#ksmass_hist.Fit("gaus","SR", "", xMin, xMax)
...
def gausProd_func(x, params):
	...
	prefac = 1.0*params[5]/(2*pi*params[1]*params[3])
	res = ( prefac * (e**expArg) ) + params[4]
	return res
...
gausProd = ROOT.TF1("gausProd", gausProd_func, xMin, xMax, 6)
gausProd.SetParameters(init_mu_1, init_sigma_1, init_mu_2, init_sigma_2, init_y_inf, init_N)
gausProd.SetLineColor(ROOT.kRed)
